-- insert into user_account (id, google_id, email, name, climber_id) values (2, '116376069439432417840', 'birgir.snorrason@gmail.com', 'Birgir Óli Snorrason', 1 );
  insert into track (id, orig_price, curr_price, price_url, price_div, product_name, email) values (1, '10000', '10000', 'https://elko.is/vorur/tp-link-axe5400-archer-axe75-netbeinir-317509/TLAXE75', '<span class="sc-b8f93654-0 jdqKfN large">(.*?)</span>', 'TP-Link AXE5400 Archer AXE75 netbeinir', 'birgir.snorrason@gmail.com' );
